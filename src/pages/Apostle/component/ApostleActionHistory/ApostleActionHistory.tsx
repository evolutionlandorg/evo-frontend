...
const StyledApostleActionHistory = styled(Box)`
  ${tw`w-full`}
`;

const ApostleActionHistory: React.FC<Props> = ({ className, landId, history }) => (
  <StyledApostleActionHistory className={className}>
  ...
  </StyledApostleActionHistory>
);

export default ApostleActionHistory;
